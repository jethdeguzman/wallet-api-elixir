defmodule WalletApp.Wallets do
  ...
  def create_wallet(%User{id: user_id}, currency) do
    %Wallet{}
  ...
  def get_user_wallets(%User{id: user_id}) do
    user_id
    |> get_wallets_query()
    |> Repo.all()
  end

  def get_user_wallet(%User{id: user_id}, wallet_uuid) do
    query = from(w in get_wallets_query(user_id), where: w.uuid == ^wallet_uuid)
    Repo.all(query)
  end

  def get_user_wallet_transactions(%User{id: user_id}, wallet_uuid) do
    query =
